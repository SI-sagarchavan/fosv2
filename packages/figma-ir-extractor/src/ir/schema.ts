...
/**
 * 1.1.0 — adds `canonicalSignature`, and moves `structuralSignature` to the
 * `s2` descriptor. A consumer must know which of these a corpus row was
 * produced with, so the version is part of every document.
 *
