/**
 * The hybrid pipeline on a WHOLE PAGE — hero, breadcrumb, a wrapping grid of
 * ten article cards, load-more, partners and legal footer.
 *
 * Runs the SHARED gallery repairs from examples/_shared — the same rules the
 * Photos page uses, unmodified.
 *
...
const IR = resolve(here, "news-page.ir.json");
